...
- Figma link <https://www.figma.com/proto/92f2Teq24jiaDRGUHg75Lr/NOVA_PAY?node-id=6002-1829&viewport=-2669%2C2893%2C0.37&t=TdrSaftXg6hpalQ1-1&scaling=scale-down&content-scaling=fixed&starting-point-node-id=6002%3A1829&page-id=0%3A1>

- AI usage: [AI_USAGE.md](./AI_USAGE.md), documents which AI tools were used, sample prompts, and specific cases where AI output needed correction.
